...
var joke = zod_1.z.object({
    setup: zod_1.z.string().describe("The setup of the joke"),
    punchline: zod_1.z.string().describe("The punchline to the joke"),
    rating: zod_1.z.number().optional().describe("How funny the joke is, from 1 to 10"),
});
var structuredLlm = model.withStructuredOutput(joke);
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, structuredLlm.invoke("Tell me a joke about cats")];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    return [2 /*return*/];
