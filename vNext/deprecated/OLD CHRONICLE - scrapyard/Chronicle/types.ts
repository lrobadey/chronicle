// --- Chronicle V2 Types Addition ---
// The following types for the Ground-Truth World Graph (GTWG) and Player-Knowledge Graph (PKG)
// are defined in preparation for V2 architecture as described in FUTURE_INTEGRATION.md.
// These types are not yet connected to any game logic or UI, and are strictly additive for future migration.
// -----------------------------------------------------------------------------
...
// Atmospheric pressure system types
...
export interface PressureState {
  ...
  // Phase 6A additions for gradual pressure changes
...
// ============================================================================
// V2: DYNAMIC REGION-BASED SYSTEM
// ============================================================================
...
// ============================================================================
// DYNAMIC REGION SYSTEM (LLM CAN CREATE ANY TYPE)
// ============================================================================
...
export interface PKG {
  discoveredFacts: PKGDiscoveredFact[];
  rumors: PKGRumor[];
  // Optionally, player-specific metadata
  metadata?: Record<string, any>;
}